...
function setup() {
    ...
    tileManager = new TileManager(64, 18, 12, 24, 108, "tileset1.png");
...
function createLabelsAndButtons() {
    ...
    // let tutorialComp = new PIXI.Text("Press Space to return to menu");
    // tutorialComp.style = bigText;
    // tutorialComp.x = 340;
    // tutorialComp.y = 580;
    // tutorialCompleteScene.addChild(tutorialComp);
}
...
function setupScenes(stage){
    ...
    // let texture = app.loader.resources["levelclear.png"].texture;
    // levelClear = new PIXI.Sprite(texture);
    // levelClear.anchor.set(0);
    //nextLevelScene.addChild(levelClear);

    //sceneManager.scenes.push(nextLevelScene);
    ...
    // sceneManager.scenes.push(gameOverScene);

    // tutorialCompleteScene = new PIXI.Container();
    // tutorialCompleteScene.visible = false;
    // stage.addChild(tutorialCompleteScene);

    // sceneManager.scenes.push(tutorialCompleteScene);
}
