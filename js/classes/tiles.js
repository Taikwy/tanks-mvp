...
class TileManager{
    ...
    setUpTextures(source){
        this.textures["tile"] = loadSpriteSheet(source, 0, this.size, this.size, 2);
        this.textures["border"] = loadSpriteSheet(source, 1, this.size, this.size, 1);
        this.textures["wall"] = loadSpriteSheet(source, 2, this.size, this.size, 2);
        this.textures["passable"] = loadSpriteSheet(source, 3, this.size, this.size, 2);
    }
    ...
    createTile(xIn = 0, yIn = 0){
        let t = new Tile(this.textures["tile"][getRandomInt(0, this.textures["tile"].length)], this.size, xIn, yIn);
    ...
    createBorderTile(xIn = 0, yIn = 0){
        let w = new WallTile(this.textures["border"], this.size, xIn, yIn);
    ...
    createWallTile(xIn = 0, yIn = 0){
        let w = new WallTile(this.textures["wall"][getRandomInt(0, this.textures["wall"].length)], this.size, xIn, yIn);
        w.x += (this.xOffset + this.size/2);
        w.y += (this.yOffset + this.size/2);
        this.tiles.push(w);
        this.walls.push(w);
    ...
    createPassableTile(xIn = 0, yIn = 0){
        let p = new WallTile(this.textures["passable"][getRandomInt(0, this.textures["passable"].length)], this.size, xIn, yIn);
...
class GroundTile extends PIXI.Sprite {
